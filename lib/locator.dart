...
import 'package:kriptum/data/repositories/contact/contacts_repository_db_impl.dart';
...
Future<void> setup() async {
  ...
  locator.registerSingleton<ContactsRepository>(ContactsRepositoryDbImpl());
